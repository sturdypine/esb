...
public interface SignatureService
{
	...
	// srcBytes表示默认的待签名内容
	String sig(IMessage msg, NodePO node, byte[] srcBytes) throws Exception;
	...
	// srcBytes表示默认的待核签内容
	// signature表示待核签的签名串
	boolean unsig(IMessage msg, NodePO node, byte[] srcBytes, String signature) throws Exception;
